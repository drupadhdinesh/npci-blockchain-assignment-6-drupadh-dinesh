...
The minter intends to transfer a non-fungible token to the Jio recipient, but first the Jio recipient needs to provide their own account ID as the payment address.
