...
export MSP_ID=${MSP_ID:-AirtelMSP}
export CRYPTO_PATH=${CRYPTO_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/Airtel}
export KEY_DIRECTORY_PATH=${KEY_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/Airtel/users/Airteladmin/msp/keystore}
export CERT_DIRECTORY_PATH=${CERT_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/Airtel/users/Airteladmin/msp/signcerts}
export TLS_CERT_PATH=${TLS_CERT_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/Airtel/msp/tlscacerts/tlsca-signcert.pem}
export PEER_ENDPOINT=${PEER_ENDPOINT:-Airtel-peer1.localho.st:443}
export PEER_HOST_ALIAS=${PEER_HOST_ALIAS:-Airtel-peer1.localho.st}
