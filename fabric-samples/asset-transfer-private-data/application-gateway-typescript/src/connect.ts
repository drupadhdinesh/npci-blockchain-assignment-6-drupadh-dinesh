...
const cryptoPathAirtel = path.resolve(
    __dirname,
    '..',
    '..',
    '..',
...
// Path to Airtel user private key directory.
export const keyDirectoryPathAirtel = path.resolve(
    cryptoPathAirtel,
    'users',
    'User1@Airtel.example.com',
    'msp',
    'keystore'
);

// Path to Airtel user certificate.
export const certDirectoryPathAirtel = path.resolve(
    cryptoPathAirtel,
    'users',
    'User1@Airtel.example.com',
    'msp',
...
// Path to Airtel peer tls certificate.
export const tlsCertPathAirtel = path.resolve(
    cryptoPathAirtel,
    'peers',
