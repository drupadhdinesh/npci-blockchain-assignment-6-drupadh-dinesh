...
public final class AssetTransferTest {
    ...
    class InvokeWriteTransaction {
        ...
        public void transferAssetWhenExistingAssetIsTransferred() {
            ...
            when(ctx.getClientIdentity()).thenReturn(ci);
            when(ci.getMSPID()).thenReturn(TEST_ORG_1_MSP);
            final String recipientOrgMsp = "TestJio";
            final String buyerIdentity = "TestJioUser";
            Map<String, byte[]> m = new HashMap<>();
    ...
    private static final String TEST_ORG_1_MSP = "TestAirtel";
    private static final String TEST_ORG_1_USER = "testAirtelUser";
    ...
    private static final byte[] DATA_ASSET_1_BYTES = "{ \"objectType\": \"testasset\", \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"testAirtelUser\", \"appraisedValue\": 300 }".getBytes();
}
