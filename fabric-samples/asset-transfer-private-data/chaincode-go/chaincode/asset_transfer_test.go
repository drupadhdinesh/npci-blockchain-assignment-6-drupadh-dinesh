...
const myAirtelMsp = "AirtelTestmsp"
const myAirtelClientid = "myAirtelUserid"
const myAirtelPrivCollection = "AirtelTestmspPrivateCollection"
const myJioMsp = "JioTestmsp"
const myJioClientid = "myJioUserid"
const myJioPrivCollection = "JioTestmspPrivateCollection"
...
func TestCreateAssetSuccessful(t *testing.T) {
	...
	require.Equal(t, myAirtelPrivCollection, calledCollection)
	require.Equal(t, "id1", calledId)
...
func TestAgreeToTransferSuccessful(t *testing.T) {
	...
	require.Equal(t, []byte(myAirtelClientid), calledWithDataBytes)
}
...
func TestTransferAssetSuccessful(t *testing.T) {
	...
	// to ensure that ReadTransferAgreement call returns Jio client ID
	chaincodeStub.GetPrivateDataReturnsOnCall(1, []byte(myJioClientid), nil)
	chaincodeStub.CreateCompositeKeyReturns(transferAgreementObjectType+"id1", nil)
	...
	expectedNewAsset.Owner = myJioClientid
...
func TestTransferAssetByNonOwner(t *testing.T) {
	...
	assetNewOwner := &assetTransferTransientInput{
		ID:       "id1",
		BuyerMSP: myAirtelMsp,
	}
	setReturnAssetOwnerInTransientMap(t, chaincodeStub, assetNewOwner)
	// Try to transfer asset owned by Jio
	JioAsset := chaincode.Asset{
		ID:    "id1",
		Type:  "testfulasset",
		Color: "gray",
		Size:  7,
	...
	setReturnPrivateDataInStub(t, chaincodeStub, &JioAsset)
	err := assetTransferCC.TransferAsset(transactionContext)
...
func prepMocksAsAirtel() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myAirtelMsp, myAirtelClientid)
}
func prepMocksAsJio() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myJioMsp, myJioClientid)
}
