...
export ORG=Airtel
export USERNAME=Jiouser
export PASSWORD=Airteluser
...
CONFIG_DIR=${TEMP_DIR}/fabric-rest-sample-config 
  ...
  local ca_pem=$ENROLLMENT_DIR/Airtel/users/$USERNAME/msp/signcerts/cert.pem
  local keyPath=$ENROLLMENT_DIR/Airtel/users/$USERNAME/msp/keystore/key.pem
