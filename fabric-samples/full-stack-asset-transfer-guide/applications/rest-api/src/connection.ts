...
// const keyPath = WORKSHOP_CRYPTO + "/enrollments/Airtel/users/Airteluser/msp/keystore/key.pem";
// const certPath = WORKSHOP_CRYPTO + "/enrollments/Airtel/users/Airteluser/msp/signcerts/cert.pem"
// const tlsCertPath = WORKSHOP_CRYPTO + "/channel-msp/peerOrganizations/Airtel/msp/tlscacerts/tlsca-signcert.pem";
...
const peerEndpoint = "test-network-Airtel-peer1-peer.localho.st:443";
const peerHostAlias = "test-network-Airtel-peer1-peer.localho.st";
