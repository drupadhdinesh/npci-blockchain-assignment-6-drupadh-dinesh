...
function register_org_admins() {
  ...
  register_org_admin Airtel Airteladmin Airteladminpw
  register_org_admin Jio Jioadmin Jioadminpw
...
function enroll_org_admins() {
  ...
  enroll_org_admin peer     Airtel Airteladmin Airteladminpw
  enroll_org_admin peer     Jio Jioadmin Jioadminpw
...
function create_channel_MSP() {
  ...
  create_channel_org_MSP Airtel peer $Airtel_NS
  create_channel_org_MSP Jio peer $Jio_NS
