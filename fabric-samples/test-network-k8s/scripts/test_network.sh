...
function launch_peers() {
  ...
  apply_template kube/Airtel/Airtel-peer1.yaml $Airtel_NS
  apply_template kube/Airtel/Airtel-peer2.yaml $Airtel_NS
  apply_template kube/Jio/Jio-peer1.yaml $Jio_NS
  apply_template kube/Jio/Jio-peer2.yaml $Jio_NS

  kubectl -n $Airtel_NS rollout status deploy/Airtel-peer1
  kubectl -n $Airtel_NS rollout status deploy/Airtel-peer2
  kubectl -n $Jio_NS rollout status deploy/Jio-peer1
  kubectl -n $Jio_NS rollout status deploy/Jio-peer2
...
function create_local_MSP() {
  ...
  create_peer_local_MSP Airtel peer1 $Airtel_NS
  create_peer_local_MSP Airtel peer2 $Airtel_NS

  create_peer_local_MSP Jio peer1 $Jio_NS
  create_peer_local_MSP Jio peer2 $Jio_NS
...
function stop_services() {
  ...
  for ns in $ORG0_NS $Airtel_NS $Jio_NS; do
