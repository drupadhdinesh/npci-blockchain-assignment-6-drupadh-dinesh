...
function construct_rest_sample_configmap() {
  ...
  echo "$(json_ccp 1 $peer_pem $ca_pem $Airtel_NS)" > build/fabric-rest-sample-config/HLF_CONNECTION_PROFILE_Airtel
  ...
  echo "$(json_ccp 2 $peer_pem $ca_pem $Jio_NS)" > build/fabric-rest-sample-config/HLF_CONNECTION_PROFILE_Jio

  cp $ENROLLMENT_DIR/Airtel/users/Airteladmin/msp/signcerts/cert.pem $CONFIG_DIR/HLF_CERTIFICATE_Airtel
  cp $ENROLLMENT_DIR/Jio/users/Jioadmin/msp/signcerts/cert.pem $CONFIG_DIR/HLF_CERTIFICATE_Jio

  cp $ENROLLMENT_DIR/Airtel/users/Airteladmin/msp/keystore/key.pem $CONFIG_DIR/HLF_PRIVATE_KEY_Airtel
  cp $ENROLLMENT_DIR/Jio/users/Jioadmin/msp/keystore/key.pem $CONFIG_DIR/HLF_PRIVATE_KEY_Jio
