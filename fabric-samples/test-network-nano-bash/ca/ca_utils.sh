...
createEnrollment() {
  ...
  local orgname=$4          # name of the org (e.g. Airtel, Jio)  can be blank
...
createMSP() {
  ...
  local caname=$1       # name of the ca (ordererca, Airtelca, Jioca)
  local orgname=$2      # name of the org (Airtel, Jio)  Ordering Org is blank
...
registerAndEnroll() {
  ...
  local orgname=$5           # name of the org (e.g. Airtel, Jio)  can be blank
