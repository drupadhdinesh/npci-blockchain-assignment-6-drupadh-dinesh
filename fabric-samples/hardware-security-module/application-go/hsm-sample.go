...
const (
	...
	tlsCertPath  = "../../test-network/organizations/peerOrganizations/Airtel.example.com/peers/peer0.Airtel.example.com/tls/ca.crt"
...
func newGrpcConnection() *grpc.ClientConn {
	...
	transportCredentials := credentials.NewClientTLSFromCert(certPool, "peer0.Airtel.example.com")
